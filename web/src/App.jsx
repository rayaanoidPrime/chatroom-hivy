...
import { ConfirmDialogProvider } from "./components/ConfirmDialog"; // TODO
import HomePageSkeleton from "./components/skeletons/HomePageSkeleton"; // TODO
import { Toaster } from "./components/Toaster"; // TODO
import { useAuthRedirect } from "./hooks/useAuthRedirect"; // TODO

const AuthWrapper = ({ children }) => {
  const { isLoading } = useAuthRedirect();

  return isLoading ? <HomePageSkeleton /> : <>{children}</>;
};
